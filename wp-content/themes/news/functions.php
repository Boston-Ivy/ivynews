                    ...
                    <ul id="featured-posts-list">
                        ...
                        foreach ($front_page_elements as $element) : ?>
                            <li class="front-page-element" id="front-page-element-<?php echo $element_counter; ?>">
                                ...
                                <a href="#"
                                   onclick="removeElement(jQuery(this).closest('.front-page-element'));">Remove</a>
                            </li>
                ...
                <div style="margin-top:30px;">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="small_banner" value="<?php echo $small_banner ?>  "
                                       id="image_url" class="regular-text">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="small_banner_link_url"
                                       value="<?php echo $small_banner_link_url ?>" id="small_banner_link_url"
                                       class="regular-text">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="small_banner_link_target">
                                    ...
                                    <option <?php if ($small_banner_link_target == '_self') {
                                        echo "selected";
                                    } ?> value="_self">Self
                                    </option>
                                    <option <?php if ($small_banner_link_target == '_blank') {
                                        echo "selected";
                                    } ?> value="_blank">New Tab
                                    </option>
                                </select>
                            </td>
                        </tr>
                ...
                <div style="margin-top: 30px;">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="banner_text" value="<?php echo $banner_text ?> "
                                       style="width:700px;" id="banner_text" class="regular-text">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="banner_text_link_url"
                                       value="<?php echo $banner_text_link_url ?>" id="banner_text_link_url"
                                       class="regular-text">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="banner_text_link_target">
                                    <option value="">Select Target</option>
                                    <option <?php if ($banner_text_link_target == '_self') {
                                        echo "selected";
                                    } ?> value="_self">Self
                                    </option>
                                    <option <?php if ($banner_text_link_target == '_blank') {
                                        echo "selected";
                                    } ?> value="_blank">New Tab
                                    </option>
                                </select>
                        ...
                        <tr>
                            ...
                            <td><?php print $ideo_tracking ?>
                                <select name="ideo_tracking">
                                    ...
                                    <option <?php if ($ideo_tracking == 0) {
                                        echo "selected";
                                    } ?> value="0">Off
                                    </option>
                                    <option <?php if ($ideo_tracking == 1) {
                                        echo "selected";
                                    } ?> value="1">On
                                    </option>
                                </select>
