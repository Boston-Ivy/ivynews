...
(function() {
  ...
  __reloader.Reloader = Reloader = (function() {
    ...
    Reloader.prototype.reloadStylesheet = function(path) {
      ...
      this.console.log("LiveReload found " + links.length + " LINKed scss, " + imported.length + " @imported scss");
      ...
      if (match) {
        ...
        this.console.log("LiveReload will reload all scss because path '" + path + "' did not match any specific one");
...
__less = LessPlugin = (function() {
  ...
  LessPlugin.prototype.reloadLess = function(path) {
    ...
    this.host.console.log("LiveReload is asking LESS to recompile all scss");
