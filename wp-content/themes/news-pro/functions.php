...
add_image_size( 'category', 240, 180, TRUE );
...
genesis_register_sidebar( array(
	...
	'description' => __( 'This is the middle section of the homepage.', 'news' ),
) );
genesis_register_sidebar( array(
	'id'          => 'home-bottom',
...
//* Boston Ivy customisation here on out
...
function sp_footer_creds_text() {
	...
	echo 'Copyright &copy; ';
	echo date('Y');
	echo ' &middot; <a href="https://bostonivy.co">Boston Ivy</a>';
	echo '</p></div>';
}
