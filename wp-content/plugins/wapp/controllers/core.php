...
class JSON_API_Core_Controller {
  ...
  public function get_options() {
    global $titan;
    $options = $titan->getAllOptions();
	$options['languages'] = function_exists('icl_get_languages')? icl_get_languages('skip_missing=0&orderby=code') : array();
	#$options['lang_selector_mode'] = 'parameter'; # parameter|path|subdomain 
    return $options;
  }
